...
import { DropDown, Like } from "../index";
import { useUpdateTweet, useDeleteTweet } from "../../hooks/tweet.hook";
...
function Tweet({ tweet, isOwner }) {
    ...
    const {mutateAsync: editTweet} = useUpdateTweet();
