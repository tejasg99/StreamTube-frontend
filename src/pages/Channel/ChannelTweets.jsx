...
import { SubscriberSkeleton, Tweet, TweetInput } from "../../components/index";
      ...
      <>
        ...
        <div className="flex justify-center p-4 mt-9">
          <div className="w-full max-w-sm text-center">
            ...
            <h5 className="mb-2 font-semibold">No Tweets posted</h5>
            <p>
              This channel yet to <strong>share</strong> a tweet
            </p>
          </div>
        </div>
      </>
